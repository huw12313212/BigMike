...
#define BOSS_MA_BULLET_COOLDOWN 3
#define BOSS_MA_HANDSHAKE_SIZE 24
#define BOSS_MA_HANDSHAKE_COLOR ccc3(100,255,100)
#define BOSS_MA_HANDSHAKE_DISTANCE 30
#define BOSS_MA_HANDSHAKE_TEXT @"死亡之握"
